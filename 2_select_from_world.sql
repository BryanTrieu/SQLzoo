-- # Show the name, continent and population for all countries
...
-- # Show the name and the per capita GDP for those countries with a population of at least 200 million
